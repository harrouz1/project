...
client.on("message", (message) => {
  ...
  if (message.content.startsWith("-close")) {
       ...
       message.channel.send(`**هل انت متأكد من اقفالك للتذكرة اذا متأكد اكتب **متاكد`)
           .then((m) => {
...
client.on('message', message => {
    ...
    var day = message.createdAt.getDate()
      ...
      .addField("**عدد الايام منذ دخولك للسيرفر:**", message.author.createdAt.getDate())
